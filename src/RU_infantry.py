...
class Tokarev_TT_33(weapon):
    name = "Tokarev TT-33"
    clip_size = 0
    max_range = 50

class Mosin_Nagant_M1891_30(weapon):
    name = "Mosin–Nagant M1891/30"
    clip_size = 5
    max_range = 400

class PPSh_41(weapon):
    name = "PPSh-41"
    clip_size = 0
    max_range = 200
...
class Squad_Leader_RU(Soldier_inf):
    weapon = PPSh_41()
    rank = ""
    primary_weapon = ""
    secondary_weapon = ""
...
class Sub_machine_Gunner_RU(Soldier_inf):
    weapon = PPSh_41()
    rank = ""
    primary_weapon = ""
    secondary_weapon = ""
...
class Machine_Gunner_RU(Soldier_inf):
    weapon = DP_27()
    rank = ""
    primary_weapon = ""
    secondary_weapon = ""
...
class Assistant_Gunner_RU(Soldier_inf):
...
def create_new_Soldier_RU(role):
	...
	ru_soldier.name = random.choice(RU_first_names) + " " + random.choice(RU_last_names)
